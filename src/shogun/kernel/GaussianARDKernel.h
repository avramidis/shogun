...
public:
	 ...
	 */
	virtual SGMatrix<float64_t> get_parameter_gradient(const std::string param_name,
			index_t index=-1);
...
protected:
	 ...
	 */
	virtual float64_t get_parameter_gradient_helper(const std::string param_name,
